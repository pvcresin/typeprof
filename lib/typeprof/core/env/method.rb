module TypeProf::Core
  ...
  class ForwardingActualArguments < ActualArguments
    def initialize(positionals, splat_flags, keywords, block, positionals_omittable, keywords_omittable, block_omittable, activation)
    ...
    def new_vertexes(genv, node)
      ...
      ForwardingActualArguments.new(positionals, splat_flags, keywords, block, @positionals_omittable, @keywords_omittable, @block_omittable, activation)
    end
    ...
    def normalize_for_method_call(genv)
      return self if @activation.types.empty?
  ...
  class ForwardingArguments
    ...
    def to_actual_arguments(genv, changes, node)
      ...
      ForwardingActualArguments.new(positionals, splat_flags, keywords, @block, positionals_omittable, keywords_omittable, true, @activation)
    end
